...
# Description: This file defines the test scenarios for the lifting of embargo.

@Regression @Embargos   @test
Feature: Procesamiento de Levantambiento de Embargo
  Como usuario del sistema
  Quiero procesar operaciones de levantambiento de embargo
  Para gestionar las solicitudes de embargo

  Scenario: TESTC-3088 Creacion de embargo basico funcion 209450 - Crear
    ...
    And el usuario selecciona el tipo de operación "4" y tipo de identificación "6"
    And el usuario ingresa el número de identificación "01800502989" y la oficina "10"
    Then el usuario presiona Enter y confirma la creacion

  Scenario: TESTC-3089 Asignacion de embargo creado funcion 209455 - Reasignar
    Given El usuario se autentica con sus credenciales
  ...
  Scenario: TESTC-3090 - TESTC-3091: Revision Operacion de Embargos funcion 209460 - Completar
    Given El usuario se autentica con sus credenciales
    Then se captura el nombre del usuario
    Then el usuario ingresa la referencia "1"
    ...
    Then El usuario navega a la pagina principal
    And El usuario crea un embargo que sea del tipo de operacion "4" y tipo de identificacion "6"
    Then El usuario navega a la pagina principal
    And El usuario se asigna el embargo "Existente" al usuario logueado
    Then El usuario navega a la pagina principal
  ...
  Scenario: TESTC-3092 Revision Operacion de Embargos funcion 209460 - Enviar a procesar estando completada
    Given El usuario se autentica con sus credenciales
    Then se captura el nombre del usuario
    Then el usuario ingresa la referencia "1"
    Given El usuario crea un embargo que sea del tipo de operacion "2" y tipo de identificacion "6"
  ...
  Scenario: TESTC-3093 Seleccion y Procesamiento de Operaciones Funcion 209465  - Consultar
    Given El usuario se autentica con sus credenciales
    Then el usuario ingresa la referencia "1"
  ...
  Scenario: TESTC-3094 - TESTC-3096 Seleccion y Procesamiento de Operaciones Funcion 209465  - Procesar Operacion
    Given El usuario se autentica con sus credenciales
    Then se captura el nombre del usuario
    Then el usuario ingresa la referencia "1"
    Given El usuario crea un embargo que sea del tipo de operacion "2" y tipo de identificacion "6"
    ...
    And el usuario procesa el embargo con tipo de operacion "4"


  Scenario: TESTC-3097 Mostrar cuenta corriente por numero de cuenta Funcion 201020
    Given El usuario se autentica con sus credenciales
    Then se captura el nombre del usuario
    Then el usuario ingresa la referencia "1"
    Given El usuario crea un embargo que sea del tipo de operacion "2" y tipo de identificacion "6"
  ...
  Scenario: TESTC-3098 Consultas y Reportes de Embargos Funcion 209470 - Consulta por operaciones
    Given El usuario se autentica con sus credenciales
    Then se captura el nombre del usuario
    Then el usuario ingresa la referencia "1"
    Given El usuario crea un embargo que sea del tipo de operacion "2" y tipo de identificacion "6"
