@Regression @Embargos
Feature: Procesamiento de Embargos Basico Cta EUR - EUR.
  Como usuario del sistema
  Quiero procesar operaciones de embargo Basico Cta
  Para gestionar las solicitudes de embargo

# Creacion de embargo basisco funcion  209450 - Crear - EUR
  Scenario: TESTC-3036 creacion de embargo basico funcion 209450 - Crear - EUR
...
# Asignaci�n de embargo creado funcion 209455 - Reasignar - EUR

  Scenario: TESTC-3037 Asignacion de embargo creado funcion 209455 - Reasignar - EUR
    Given El usuario se autentica con sus credenciales
...
# Revisi�n Operaci�n de Embargos funcion 209460 - Completar - EUR

  Scenario: TESTC-3038: Revision Operacion de Embargos funcion 209460 - Completar - EUR
    Given El usuario se autentica con sus credenciales
    Then se captura el nombre del usuario
    Then el usuario ingresa la referencia "1"
    Given El usuario crea un embargo que sea del tipo de operacion "2" y tipo de identificacion "6" y del tipo de moneda "2"
    Then El usuario navega a la pagina principal
...
# Revisi�n Operaci�n de Embargos funcion 209460 - Enviar a procesar estando completada - EUR
  Scenario: TESTC-3040 Revision Operacion de Embargos funcion 209460 - Enviar a procesar estando completada - EUR
    Given El usuario se autentica con sus credenciales
    Then se captura el nombre del usuario
    Then el usuario ingresa la referencia "1"
    Given El usuario crea un embargo que sea del tipo de operacion "2" y tipo de identificacion "6" y del tipo de moneda "2"
...
# Seleccion y pocesamiento de operacion (Consultar) - EUR
  Scenario: TESTC-3267 Selecci�n y Procesamiento de Operaciones Funcion 209465  - Consultar - EUR
    Given El usuario se autentica con sus credenciales
...
# Selecci�n y Procesamiento de Operaciones Funcion 209465 - Procesar Operaci�n - EUR
  Scenario: TESTC-3042 Selecci�n y Procesamiento de Operaciones Funcion 209465  - Procesar Operaci�n - EUR
    Given El usuario se autentica con sus credenciales
    Then se captura el nombre del usuario
    Then el usuario ingresa la referencia "1"
    Given El usuario crea un embargo que sea del tipo de operacion "2" y tipo de identificacion "6" y del tipo de moneda "2"
...
# Selecci�n y Procesamiento de Operaciones Funcion 209465  - Procesar Operaci�n - EUR
  Scenario: TESTC-3043 Selecci�n y Procesamiento de Operaciones Funcion 209465  - Procesar Operaci�n - EUR
    Given El usuario se autentica con sus credenciales
    Then se captura el nombre del usuario
    Then el usuario ingresa la referencia "1"
    Given El usuario crea un embargo que sea del tipo de operacion "2" y tipo de identificacion "6" y del tipo de moneda "2"
...
# Selecci�n y Procesamiento de Operaciones Funcion 209465  - Procesar Operaci�n -EUR
  Scenario:TESTC-3044 Selecci�n y Procesamiento de Operaciones Funcion 209465  - Procesar Operaci�n - EUR
    Given El usuario se autentica con sus credenciales
    Then se captura el nombre del usuario
    Then el usuario ingresa la referencia "1"
    Given El usuario crea un embargo que sea del tipo de operacion "2" y tipo de identificacion "6" y del tipo de moneda "2"
...
#Mostrar cuenta corriente por n�mero de cuenta  Funcion  201020  - Consulta de cuenta seg�n aplique - EUR
  Scenario: TESTC-3045 - 3046 Mostrar cuenta corriente por n�mero de cuenta  Funcion  201020  - Consulta de cuenta seg�n aplique  - EUR
    Given El usuario se autentica con sus credenciales
    Then se captura el nombre del usuario
    Then el usuario ingresa la referencia "1"
    Given El usuario crea un embargo que sea del tipo de operacion "2" y tipo de identificacion "6" y del tipo de moneda "2"
