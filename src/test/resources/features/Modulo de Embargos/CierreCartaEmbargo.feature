@Regression @Embargos
Feature: Procesamiento de Embargos cirre carta compromiso
  Como usuario del sistema
  Quiero procesar operaciones de embargo  cirre carta compromiso
  Para gestionar las solicitudes de embargo

   #El tipo de operacion 11 representa cierre carta
  Scenario: TESTC-3132 creacion de embargo basico funcion 209450 - Crear
    ...
    And el usuario selecciona el tipo de operación "11" y tipo de identificación "6"
  ...
  Scenario: TESTC-3133 Asignacion de embargo creado funcion 209455 - Reasignar
    Given El usuario se autentica con sus credenciales
  ...
  Scenario: TESTC-3134 - TESTC-3135: Revision Operacion de Embargos funcion 209460 - Completar
    Given El usuario se autentica con sus credenciales
    Then se captura el nombre del usuario
    Then el usuario ingresa la referencia "1"
    ...
    And El usuario se asigna el embargo "Existente" al usuario logueado
    Then El usuario navega a la pagina principal
    And el usuario completa y procesa el embargo "Existente" con el numero de operacion anterior "Existente" y el monto anterior "" y el tipo de operacion "8"
    Then El usuario navega a la pagina principal
    And El usuario crea un embargo que sea del tipo de operacion "11" y tipo de identificacion "6"
    Then El usuario navega a la pagina principal
    And El usuario se asigna el embargo "Existente" al usuario logueado
    Then El usuario navega a la pagina principal
  ...
  Scenario: TESTC-3137 Selecci�n y Procesamiento de Operaciones Funcion 209465  - Consultar
    Given El usuario se autentica con sus credenciales
  ...
  Scenario: TESTC-3136-3138-3139-3140 Seleccion y Procesamiento de Operaciones Funcion 209465  - Procesar Operacion
    Given El usuario se autentica con sus credenciales
    Then se captura el nombre del usuario
    Then el usuario ingresa la referencia "1"
    Given El usuario crea un embargo que sea del tipo de operacion "2" y tipo de identificacion "6"
    ...
    And el usuario procesa el embargo con tipo de operacion "11"


  Scenario: TESTC-3141 Mostrar cuenta corriente por numero de cuenta Funcion 201020
    Given El usuario se autentica con sus credenciales
    Then se captura el nombre del usuario
    Then el usuario ingresa la referencia "1"
    Given El usuario crea un embargo que sea del tipo de operacion "2" y tipo de identificacion "6"
  ...
  Scenario: TESTC-3142 Consultas y Reportes de Embargos Funcion 209470 - Consulta por operaciones
    Given El usuario se autentica con sus credenciales
    Then se captura el nombre del usuario
    Then el usuario ingresa la referencia "1"
    Given El usuario crea un embargo que sea del tipo de operacion "2" y tipo de identificacion "6"
